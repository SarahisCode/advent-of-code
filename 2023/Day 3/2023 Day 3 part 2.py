schematic = """................................................965..583........389.................307.................512......................395.....387
...
.............................87...622..........................822...............................................215.............810........""".strip().split("\n")

total_length = len(schematic)
line_length = len(schematic[0])
def valid_x(x_value):
    return 0 <= x_value < line_length

def valid_y(y_value):
    return 0 <= y_value < total_length


def num_works(lead_coord, current_number):
    for check_y in (lead_coord["y"]-1, lead_coord["y"], lead_coord["y"]+1):
        if not valid_y(check_y):
            continue
        for check_x in range(lead_coord["x"]-1, lead_coord["x"]+len(current_number)+1):
            if not valid_x(check_x):
                continue
            char_at = schematic[check_y][check_x]
            if char_at not in numbers and char_at != ".":
                return True
    return False
    ...
    for x, char in enumerate(line):
        if char in numbers:
            if has_number:
                ...
                lead_coord = (x,y)
                has_number = True
        elif char not in numbers and has_number:
            schematic_nums[lead_coord] = current_number
            current_number = ""
            has_number = False
    if has_number:
        schematic_nums[lead_coord] = current_number
        current_number = ""
        has_number = False
print(schematic_nums)
for y, line in enumerate(schematic):
    for x, char in enumerate(line):
        if char == "*":
            coord = (x,y)
            adjacent_nums = []
            for lead_coord in schematic_nums:
                if -1 <= coord[1] - lead_coord[1] <= 1:
                    if -1 <= coord[0] - lead_coord[0] <= len(schematic_nums[lead_coord]):
                        adjacent_nums.append(int(schematic_nums[lead_coord]))
            if len(adjacent_nums) == 2:
                _sum += adjacent_nums[0] * adjacent_nums[1]
print(_sum)
