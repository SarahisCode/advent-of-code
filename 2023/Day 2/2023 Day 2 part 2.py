lines = open("2023/Day 2/2023_Day_2_input.txt", "r").readlines()
lines = """Game 1: 4 red, 5 blue, 9 green; 7 green, 7 blue, 3 red; 16 red, 7 blue, 3 green; 11 green, 11 blue, 6 red; 12 red, 14 blue
...
print(lines)
for line in lines:
    _dict = {"red":0, "blue":0, "green":0}
    print(line)
    game_number = int(line.split(": ")[0].split(" ")[1])
    boxes = [i.split("; ") for i in line.split(": ")[1].split(", ")]
    valid = True
    for j in boxes:
        for i in j:
          print(i)
          if int(i.split(" ")[0]) > _dict[i.split(" ")[1]]:
            _dict[i.split(' ')[1]] = int(i.split(" ")[0])
    print(valid)
    s_um += _dict["green"]*_dict["blue"]*_dict["red"]
print(s_um)